...
<section class="my-20">
	<div class="con-3 flex flex-row mx-auto px-3 justify-around">
		<div>
			<span>총 주문금액</span>
      		 <span>15,000 원</span>
		</div>
		<button id="payment-button" class="text-center btn btn-active btn-secondary mt-4">15,000원 결제하기</button>
	</div>
</section>
